  ...
  return (
    <Section id="poverty-line">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative">
        {/* Enterprise card */}
        <div className="rounded-2xl border border-pr-indigo-800 bg-pr-indigo-900/50 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-pr-ink-500">
                Fortune 500 Reality
              </p>
              <h3 className="font-display text-xl font-bold text-white">Enterprise Security</h3>
            </div>
          </div>
          <ul className="space-y-3">
            {enterpriseItems.map((item) => (
              <li key={item} className="flex items-start gap-3 text-slate-300 text-sm">
                <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-pr-blue-500" />
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hidden lg:flex flex-col items-center">
          <div
            className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-pr-cyan-400 text-pr-cyan-400 font-display font-bold text-xs text-center"
            style={{
              background: 'linear-gradient(135deg, #1E1B4B, #14132B)',
              boxShadow: '0 0 24px rgba(34,211,238,0.25)',
            }}
          >
            PR
          </div>
          <p className="mt-2 text-xs text-pr-cyan-400 font-semibold tracking-wide whitespace-nowrap">
            We bridge the gap
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-red-900/50 bg-red-950/20 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h3 className="font-display text-xl font-bold text-white">Below the Line</h3>
            </div>
          </div>
          <ul className="space-y-3">
